    ...
    render() {
        return (
            <div className="profile-body">
                ...
                {/*                 className="r-14j79pv r-4qtqp9 r-yyyyoo r-1xvli5t r-1d4mawv r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"><g><path*/}
                {/*                d="M12 14.315c-2.088 0-3.787-1.698-3.787-3.786S9.913 6.74 12 6.74s3.787 1.7 3.787 3.787-1.7 3.785-3.787 3.785zm0-6.073c-1.26 0-2.287 1.026-2.287 2.287S10.74 12.814 12 12.814s2.287-1.025 2.287-2.286S13.26 8.24 12 8.24z"></path><path*/}
                ...
                {/*                                                                r="1.285"></circle><circle cx="16.968"*/}
                {/*                                                                                           cy="8.75"*/}
                {/*                                                                                           r="1.285"></circle><circle*/}
                {/*                cx="16.968" cy="13.156" r="1.285"></circle><circle cx="12" cy="8.75" r="1.285"></circle><circle*/}
                {/*                cx="12" cy="13.156" r="1.285"></circle><circle cx="7.032" cy="17.486"*/}
                {/*                                                               r="1.285"></circle><circle cx="12"*/}
                {/*                                                                                          cy="17.486"*/}
                ...
                {/*    <span><b id="followers"></b> Following</span>*/}
                {/*    <span><b id="following"></b> Followers</span>*/}
                {/*</div>*/}
            </div>
        );
    }
