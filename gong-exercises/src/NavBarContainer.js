...
class NavItem extends React.Component {
    ...
    render() {
        return (
            <div className="nav-item" id="home-nav-item">
        ...
        return (
            <div className="nav-container">
                <div className="nav-menu">
                    <NavItem sectionName="Home"/>
                    <NavItem sectionName="Notifications"/>
                    <NavItem sectionName="Messages"/>
                    <NavItem sectionName="Bookmarks"/>
